...
import pandas as pd
from huggingface_hub import hf_hub_dowwnload
import joblib

model_path=hf_hub_download(repo_id='Harsha1001/Machine-Failure-Prediction',filename='best_machine_model_v1.joblib')
